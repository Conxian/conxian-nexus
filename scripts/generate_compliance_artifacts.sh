...
raise SystemExit(0 if matches == [("xxhash-rust", "0.8.18")] else f"unexpected xxhash-rust resolution: {matches}")
'; then
...
grep -q "lib-conxian-core 0.3.0" "${output_dir}/THIRD_PARTY_LICENSES.html"
