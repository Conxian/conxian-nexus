#!/usr/bin/env python3
"""Focused tests for checkout-independent, reference-consistent SBOM output."""
...
class NormalizeSbomTests(unittest.TestCase):
    def test_distinct_checkout_prefixes_have_identical_references_and_hashes(self):
        ...
        self.assertEqual(
            outputs[0]["metadata"]["component"]["components"][0]["bom-ref"],
            outputs[0]["dependencies"][0]["dependsOn"][0],
        )
